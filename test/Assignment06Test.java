...
public final class Assignment06Test {
    ...
    static class TestListener implements PropertyChangeListener, VetoableChangeListener {
        ...
        public PropertyChangeEvent lastEvent() {
            PropertyChangeEvent tmp = lastEvent;
            lastEvent = null;
            return tmp;
        }
    ...
    public void setUp() {
        ...
        CompensationManager compMgr = new CompensationManager();
        BenefitManager bm = new BenefitManager();
    ...
    public void testTerminations() {
        ...
        Iterator<StaffConsultant> iter = consultantList.iterator();
        if (iter.hasNext()) {
            StaffConsultant consultant = iter.next();
